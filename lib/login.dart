...
import 'package:sheria_legal/screens/forgot_password.dart';
...
import 'package:sheria_legal/widgets/widget.dart';
      ...
      await authService
        ...
        if (result != null) {
          QuerySnapshot userInfoSnapshot =
              await UserManagement().getUserInfo(emailEditingController.text);
